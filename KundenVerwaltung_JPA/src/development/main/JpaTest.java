...
import development.model.Family;
import development.model.Person;
...
public class JpaTest {
	...
	public void setUp() throws Exception {
		...
		javax.persistence.Query q = em.createQuery("select m from Person m");
	...
	public void checkFamily() {
		...
		javax.persistence.Query q = em.createQuery("select f from Family f");
